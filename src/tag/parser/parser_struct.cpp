            ...
            switch(vt_type) {
                ...
                case ParserStructValue::ValueType::VALUE_TYPE_TAGDATAOFFSET: {
                    ...
                    if(vt_data != vo_data) {
                        ...
                        std::snprintf(difference_text, sizeof(difference_text), "%scrc32: 0x%08X %s 0x%08X%s", indent.c_str(), vt_crc32, crc32_different ? "!=" : "==", vo_crc32, crc32_different ? "" : " (possibly spoofed)");
                        differences_array->emplace_back(difference_text);
                    }
                    break;
                }

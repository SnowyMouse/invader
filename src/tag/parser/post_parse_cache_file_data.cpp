...
namespace Invader::Parser {
    ...
    void Invader::Parser::Glow::post_parse_cache_file_data(Invader::Tag const &, std::optional<HEK::Pointer>) {
    ...
    void Invader::Parser::PointPhysics::post_parse_cache_file_data(Invader::Tag const &, std::optional<HEK::Pointer>) {
        this->air_friction /= 10000.0f;
        this->water_friction /= 10000.0f;
    }

    void Invader::Parser::Projectile::post_parse_cache_file_data(Invader::Tag const &, std::optional<HEK::Pointer>) {
        this->initial_velocity *= TICK_RATE;
        this->final_velocity *= TICK_RATE;
    }

    void Invader::Parser::ScenarioCutsceneTitle::post_parse_cache_file_data(Invader::Tag const &, std::optional<HEK::Pointer>) {

...
namespace Invader::HEK {
    ...
    enum ShaderColorFunctionType : TagEnum {
        SHADER_ANIMATION_COLOR_FUNCTION_CURRENT,
        SHADER_ANIMATION_COLOR_FUNCTION_NEXT_MAP,
        SHADER_ANIMATION_COLOR_FUNCTION_MULTIPLY,
        SHADER_ANIMATION_COLOR_FUNCTION_DOUBLE_MULTIPLY,
        SHADER_ANIMATION_COLOR_FUNCTION_ADD,
        SHADER_ANIMATION_COLOR_FUNCTION_ADD_SIGNED_CURRENT,
        SHADER_ANIMATION_COLOR_FUNCTION_ADD_SIGNED_NEXT_MAP,
        SHADER_ANIMATION_COLOR_FUNCTION_SUBTRACT_CURRENT,
        SHADER_ANIMATION_COLOR_FUNCTION_SUBTRACT_NEXT_MAP,
        SHADER_ANIMATION_COLOR_FUNCTION_BLEND_CURRENT_ALPHA,
        SHADER_ANIMATION_COLOR_FUNCTION_BLEND_CURRENT_ALPHA_INVERSE,
        SHADER_ANIMATION_COLOR_FUNCTION_BLEND_NEXT_MAP_ALPHA,
        SHADER_ANIMATION_COLOR_FUNCTION_BLEND_NEXT_MAP_ALPHA_INVERSE
    };

    enum ShaderAnimationSource : TagEnum {
        SHADER_ANIMATION_ANIMATION_SOURCE_NONE,
        SHADER_ANIMATION_ANIMATION_SOURCE_A_OUT,
        SHADER_ANIMATION_ANIMATION_SOURCE_B_OUT,
        SHADER_ANIMATION_ANIMATION_SOURCE_C_OUT,
        SHADER_ANIMATION_ANIMATION_SOURCE_D_OUT
    };

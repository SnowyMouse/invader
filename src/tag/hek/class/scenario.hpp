...
namespace Invader::HEK {
    ...
    enum ScenarioScriptReturnType : TagEnum {
        SCENARIO_SCRIPT_RETURN_TYPE_UNPARSED,
        SCENARIO_SCRIPT_RETURN_TYPE_SPECIAL_FORM,
        SCENARIO_SCRIPT_RETURN_TYPE_FUNCTION_NAME,
        SCENARIO_SCRIPT_RETURN_TYPE_PASSTHROUGH,
        SCENARIO_SCRIPT_RETURN_TYPE_VOID,
        SCENARIO_SCRIPT_RETURN_TYPE_BOOLEAN,
        SCENARIO_SCRIPT_RETURN_TYPE_REAL,
        SCENARIO_SCRIPT_RETURN_TYPE_SHORT,
        SCENARIO_SCRIPT_RETURN_TYPE_LONG,
        SCENARIO_SCRIPT_RETURN_TYPE_STRING,
        SCENARIO_SCRIPT_RETURN_TYPE_SCRIPT,
        SCENARIO_SCRIPT_RETURN_TYPE_TRIGGER_VOLUME,
        SCENARIO_SCRIPT_RETURN_TYPE_CUTSCENE_FLAG,
        SCENARIO_SCRIPT_RETURN_TYPE_CUTSCENE_CAMERA_POINT,
        SCENARIO_SCRIPT_RETURN_TYPE_CUTSCENE_TITLE,
        SCENARIO_SCRIPT_RETURN_TYPE_CUTSCENE_RECORDING,
        SCENARIO_SCRIPT_RETURN_TYPE_DEVICE_GROUP,
        SCENARIO_SCRIPT_RETURN_TYPE_AI,
        SCENARIO_SCRIPT_RETURN_TYPE_AI_COMMAND_LIST,
        SCENARIO_SCRIPT_RETURN_TYPE_STARTING_PROFILE,
        SCENARIO_SCRIPT_RETURN_TYPE_CONVERSATION,
        SCENARIO_SCRIPT_RETURN_TYPE_NAVPOINT,
        SCENARIO_SCRIPT_RETURN_TYPE_HUD_MESSAGE,
        SCENARIO_SCRIPT_RETURN_TYPE_OBJECT_LIST,
        SCENARIO_SCRIPT_RETURN_TYPE_SOUND,
        SCENARIO_SCRIPT_RETURN_TYPE_EFFECT,
        SCENARIO_SCRIPT_RETURN_TYPE_DAMAGE,
        SCENARIO_SCRIPT_RETURN_TYPE_LOOPING_SOUND,
        SCENARIO_SCRIPT_RETURN_TYPE_ANIMATION_GRAPH,
        SCENARIO_SCRIPT_RETURN_TYPE_ACTOR_VARIANT,
        SCENARIO_SCRIPT_RETURN_TYPE_DAMAGE_EFFECT,
        SCENARIO_SCRIPT_RETURN_TYPE_OBJECT_DEFINITION,
        SCENARIO_SCRIPT_RETURN_TYPE_GAME_DIFFICULTY,
        SCENARIO_SCRIPT_RETURN_TYPE_TEAM,
        SCENARIO_SCRIPT_RETURN_TYPE_AI_DEFAULT_STATE,
        SCENARIO_SCRIPT_RETURN_TYPE_ACTOR_TYPE,
        SCENARIO_SCRIPT_RETURN_TYPE_HUD_CORNER,
        SCENARIO_SCRIPT_RETURN_TYPE_OBJECT,
        SCENARIO_SCRIPT_RETURN_TYPE_UNIT,
        SCENARIO_SCRIPT_RETURN_TYPE_VEHICLE,
        SCENARIO_SCRIPT_RETURN_TYPE_WEAPON,
        SCENARIO_SCRIPT_RETURN_TYPE_DEVICE,
        SCENARIO_SCRIPT_RETURN_TYPE_SCENERY,
        SCENARIO_SCRIPT_RETURN_TYPE_OBJECT_NAME,
        SCENARIO_SCRIPT_RETURN_TYPE_UNIT_NAME,
        SCENARIO_SCRIPT_RETURN_TYPE_VEHICLE_NAME,
        SCENARIO_SCRIPT_RETURN_TYPE_WEAPON_NAME,
        SCENARIO_SCRIPT_RETURN_TYPE_DEVICE_NAME,
        SCENARIO_SCRIPT_RETURN_TYPE_SCENERY_NAME
    };
    ...
    ENDIAN_TEMPLATE(EndianType) struct ScenarioScript {
        ...
        EndianType<ScenarioScriptReturnType> return_type;
    ...
    ENDIAN_TEMPLATE(EndianType) struct ScenarioGlobal {
        TagString name;
        EndianType<ScenarioScriptReturnType> type;
        PAD(0x2);
        PAD(0x4);
